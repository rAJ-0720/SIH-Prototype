    ...
    <header className="sticky top-0 z-30 bg-stone-50/80 backdrop-blur-md border-b border-stone-200/60">
      <div className="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h2 className="font-display font-bold text-lg sm:text-xl text-stone-900 truncate">{t(title)}</h2>
          <p className="text-xs sm:text-sm text-stone-500 truncate hidden sm:block">{t(subtitle)}</p>
        </div>
